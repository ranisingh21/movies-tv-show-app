        ...
        <div id="carouselExample" className="carousel slide" data-bs-ride="carousel">
          <div className="carousel-inner">
            ...
            <div className="carousel-item">
              <img 
                src="https://wallpapercave.com/wp/wp1934740.jpg" 
                className="d-block w-100" 
                alt="Second Slide" 
              />
            </div>
            <div className="carousel-item">
              <img 
                src="https://m.media-amazon.com/images/M/MV5BOThkYjg5ZjctNmIyNS00MzY2LTg1MDgtYjcxZDVjNjdhYjE1XkEyXkFqcGc@._V1_.jpg" 
                className="d-block w-100" 
                alt="Third Slide" 
              />
            </div>
            <div className="carousel-item">
              <img 
                src="https://wallpapercave.com/wp/wp4102519.jpg" 
                className="d-block w-100" 
                alt="Fourth Slide" 
              />
            </div>
